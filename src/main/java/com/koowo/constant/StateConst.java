...
public class StateConst {
    ...
    //已经正常结束的记录
    public static Integer PAYLOG_STATE_NORMAL = new Integer("0");
    //正在等待支付的记录
    public static Integer PAYLOG_STATE_WAIT = new Integer("1");

    //待处理
    public static Integer PAYORDER_PAYSTATE_WAIT = new Integer("0");
    //已成功
    public static Integer PAYORDER_STATE_USED = new Integer("1");
    //管理员手动处理
    public static Integer PAYORDER_STATE_ADMIN_MOD = new Integer("2");
