package com.koowo.controller.${packageName}.${objectNameLower};
...
import com.koowo.controller.base.BaseController;
import com.koowo.entity.Page;
...
import com.koowo.service.${packageName}.${objectNameLower}.${objectName}Service;
