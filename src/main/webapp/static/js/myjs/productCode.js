 ...
 */	
	...
	function saveD(){
		...
		var fields = dname + ',koowo,' + dtype + ',koowo,' + dbz + ',koowo,' + isQian + ',koowo,' + ddefault;
	...
	function editField(value,msgIndex){
		var efieldarray = value.split(',koowo,');
	...
	function appendC(value){
		...
		var fieldarray = value.split(',koowo,');
	...
	function isSame(value){
		for(var i=0;i<arField.length;i++){
			var array0 = arField[i].split(',koowo,')[0];
			if(array0 == value){
				return false;
			}
		}
